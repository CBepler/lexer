...
//!
//! This crate provides a powerful macro-based approach to defining programming language lexers with
//! support for keywords, operators, identifiers, literals, whitespace, and comments, including
//! intricate features like paired delimiters and multi-line comments.
//!
//! ---
//!
//! ## Getting Started
